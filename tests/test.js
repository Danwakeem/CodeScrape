...
describe('Testing codepad responses', () => {
  ...
  describe('parseOutput() should', () => {
    ...
    it('grab the output from the pre defined html', () => {
      scrape.parseOutput(invalidOutput).should.deepEqual({ output: 'Error: We are unable to run your code. Please try again later.' });
    });
  });
